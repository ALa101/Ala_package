...
setup(
  name = 'Ala_package',         # How you named your package folder (MyLib)
  packages = ['Ala_package'],   # Chose the same as "name"
  version = '0.0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'this challeng T.Amall, to cours python',   # Give a short description about your library
  ...
  classifiers=[
    ...
    'Intended Audience :: edoucation',      # Define that your audience are developers
